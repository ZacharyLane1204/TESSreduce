...
def _find_bkg_cor(tess,cores):
    ...
    cor = Parallel(n_jobs=cores, backend="multiprocessing", verbose=1)(delayed(_parallel_correlation)
...
def multi_correlation_cor(tess, limit=0.8, cores=7):
    ...
    results = Parallel(n_jobs=cores, backend="multiprocessing", verbose=1)(
