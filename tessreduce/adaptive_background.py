...
def adaptive_medfilt_3d(
    ...
    if metric in ('deviation', 'combined'):
        ...
        all_devs = Parallel(n_jobs=n_jobs, backend="multiprocessing")(delayed(_compute_dev)(cw) for cw in scales)
        ...
        scale_norms = Parallel(n_jobs=n_jobs, backend="multiprocessing")(
    ...
    for s, e in segments:
        ...
        for w, smoothed_w in Parallel(n_jobs=n_jobs, backend="multiprocessing")(delayed(_smooth_seg)(w) for w in seg_levels):
